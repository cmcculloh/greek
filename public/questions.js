...
const config = {
	...
	questions: [
		...
		{ level: 27, question: ['ό ούπος'], answer: ['the heaven']},
		{ level: 27, question: ['ό τόπος'], answer: ['the place']},
		{ level: 27, question: ['ό διδάσκαλος'], answer: ['the teacher']},
		{ level: 27, question: ['ό λίθος'], answer: ['the stone']},
		{ level: 28, question: ['-ος (singular)'], answer: ['-ος', '-ου', '-ω', '-ον']},
		{ level: 28, question: ['άνθρωπος (singular)'], answer: ['άνθρωπος', 'άνθρωπου', 'άνθρωπω', 'άνθρωπον']},
		{ level: 28, question: ['-ος (plural)'], answer: ['-οι', '-ων', '-οις', '-ους']},
		{ level: 28, question: ['άνθρωπος (plural)'], answer: ['άνθρωποι', 'άνθρωπων', 'άνθρωποις', 'άνθρωπους']},

		{ level: 29, question: ['-ος (singular nominative)'], answer: ['-ος']},
		{ level: 29, question: ['άνθρωπος (singular nominative)'], answer: ['άνθρωπος']},
		{ level: 29, question: ['-ος (plural nominative)'], answer: ['-οι']},
		{ level: 29, question: ['άνθρωπος (plural nominative)'], answer: ['άνθρωποι']},

		{ level: 30, question: ['-ος (singular genitive)'], answer: ['-ου']},
		{ level: 30, question: ['άνθρωπος (singular genitive)'], answer: ['άνθρωπου']},
		{ level: 30, question: ['-ος (plural genitive)'], answer: ['-ων']},
		{ level: 30, question: ['άνθρωπος (plural genitive)'], answer: ['άνθρωπων']},

		{ level: 31, question: ['-ος (singular dative)'], answer: ['-ω']},
		{ level: 31, question: ['άνθρωπος (singular dative)'], answer: ['άνθρωπω']},
		{ level: 31, question: ['-ος (plural dative)'], answer: ['-οις']},
		{ level: 31, question: ['άνθρωπος (plural dative)'], answer: ['άνθρωποις']},

		{ level: 32, question: ['-ος (singular accusative)'], answer: ['-ον']},
		{ level: 32, question: ['άνθρωπος (singular accusative)'], answer: ['άνθρωπον']},
		{ level: 32, question: ['-ος (plural accusative)'], answer: ['-ους']},
		{ level: 32, question: ['άνθρωπος (plural accusative)'], answer: ['άνθρωπους']},

		{ level: 33, question: ['έγείρω'], answer: ['I raise up']},
		{ level: 33, question: ['άγω'], answer: ['I lead']},
		{ level: 33, question: ['μένω'], answer: ['I remain']},
		{ level: 33, question: ['πέμπω'], answer: ['I send']},
		{ level: 33, question: ['φέρω'], answer: ['I bear', 'I bring']},
		{ level: 33, question: ['βαπτίζω'], answer: ['I baptize']},

		{ level: 34, question: ['κρίνω'], answer: ['I judge']},
		{ level: 34, question: ['τό τέκνον'], answer: ['the child']},
		{ level: 34, question: ['τό εύαγγέλιον'], answer: ['the gospel']},
		{ level: 34, question: ['τό πρόσωπον'], answer: ['the face']},
		{ level: 34, question: ['τό ίερόν'], answer: ['the temple']},
		{ level: 34, question: ['τό δώρον'], answer: ['the gift']},

		{ level: 35, question: ['masculine noun'], answer: ['ό διδάσκαλος', 'ό τόπος', 'ό ούπος', 'ό κύριος', 'ό υίός', 'ό οίκος', 'ό θάνατος']},
		{ level: 35, question: ['neuter noun'], answer: ['τό τέκνον', 'τό εύαγγέλιον', 'τό πρόσωπον', 'τό ίερόν', 'τό δώρον']},
		{ level: 35, question: ['noun'], answer: ['τό τέκνον', 'τό εύαγγέλιον', 'τό πρόσωπον', 'τό ίερόν', 'τό δώρον']},
		{ level: 35, question: ['verb'], answer: ['έγείρω', 'άγω', 'μένω', 'πέμπω', 'φέρω', 'βαπτίζω', 'κρίνω']},
